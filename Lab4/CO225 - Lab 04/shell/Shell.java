...
public class Shell { 
	 ...
	 */
    commands.put("less", new Less());   // initialize "less" command
    commands.put("copy", new Copy());   // initialize "copy" command
	commands.put("quit", new Quit());   // initialize "quit" command
    }
    ...
    // add count to check how many commands run
    commandCount += 1;
